"""
Structured JSON logging setup for p6 research agent.
...
class JsonFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        log_entry: dict = {
            ...
            "service.name": os.getenv("SERVICE_NAME", "p6-research-agent"),
...
def setup_logging(name: str = "p6-research-agent") -> logging.Logger:
    """
